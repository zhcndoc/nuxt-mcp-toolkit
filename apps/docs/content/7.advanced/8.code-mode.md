...
::prompt
---
description: Enable Code Mode in the MCP server
icon: i-lucide-code
actions:
  - copy
  - cursor
...
- Install secure-exec: `pnpm add secure-exec` or `npm install secure-exec` or `yarn add secure-exec` or `bun add secure-exec` (Node >=18.16.0)
