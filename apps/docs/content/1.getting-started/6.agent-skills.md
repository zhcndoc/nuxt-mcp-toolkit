...
- [Tools](/tools/overview) - Learn how to create MCP tools
- [Resources](/resources/overview) - Expose data via MCP resources
- [Prompts](/prompts/overview) - Create reusable prompt templates
- [Apps](/apps/overview) - Ship interactive UI widgets to AI hosts
